# NexusCRM: Smart Customer Engine

A vanilla JavaScript project that manages a customer database and calculates
dynamic rewards, shipping, and membership logic.
...
- **CSS3:** Flexbox layout for customer cards.
- **JavaScript:** ES6+ (Arrays, Objects, Arrow Functions, Filter).
